...
Ein Durchlauf von `./test.sh` dauert auf diesem Rechner rund 2 Minuten
(14 echte QEMU-Boots).
...
Host-Tests der hardwarefreien Logik allein (141 Tests, laufen in Sekunden):
...
1. Host-Tests (141) · 2. Build mit POSIX · 3. Build ohne POSIX ·
...
10/19 Selbsttest NX: Daten ausfuehren                               => bestanden
11/19 Selbsttest #GP: nicht kanonische Adresse                      => bestanden
...
16/19 Verdraengung: Wechsel ohne freiwilliges yield                 => bestanden
17/19 Ring 3: unprivilegiertes Programm, Systemaufruf, Negativtest  => bestanden
18/19 ELF-Lader: Programm aus dem Startdateisystem                  => bestanden
...
`Selbsttestbilanz: 126/126 bestanden`.
